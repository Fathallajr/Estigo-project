...
export class UploadLessonComponent implements OnInit {
  ...
  // API Endpoints
  readonly COURSES_API_URL = 'https://estigo.runasp.net/api/Teacher/teacher-courses';
  readonly LESSON_API_URL = 'https://estigo.runasp.net/api/Lesson';
  readonly VIDEO_BASE_URL = 'https://estigo.runasp.net/'; // For non-live video files
